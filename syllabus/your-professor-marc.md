...
* by email (marc.saurette @ carleton.ca) before class starts
* (after class starts) via Slack direct messages
* I'll have regular office hours either in person or via Slack
